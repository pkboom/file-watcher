...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/pkboom/phpunit-watcher.svg?style=flat-square)](https://packagist.org/packages/pkboom/phpunit-watcher)
![Tests](https://github.com/pkboom/phpunit-watcher/workflows/Tests/badge.svg)
[![Total Downloads](https://img.shields.io/packagist/dt/pkboom/phpunit-watcher.svg?style=flat-square)](https://packagist.org/packages/pkboom/phpunit-watcher)
...
![watcher screenshot](https://pkboom.github.io/phpunit-watcher/screenshots/watcher.jpg)
...
[![Amo Chohan demo](https://pkboom.github.io/phpunit-watcher/videothumb.png)](https://youtu.be/CF1UhUj9LG0?t=26m13s)

## Support us

[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/phpunit-watcher.jpg?t=1" width="419px" />](https://pkboom.be/github-ad-click/phpunit-watcher)

We invest a lot of resources into creating [best in class open source packages](https://pkboom.be/open-source). You can support us by [buying one of our paid products](https://pkboom.be/open-source/support-us).

We highly appreciate you sending us a postcard from your hometown, mentioning which of our package(s) you are using. You'll find our address on [our contact page](https://pkboom.be/about-us). We publish all received postcards on [our virtual postcard wall](https://pkboom.be/open-source/postcards).
...
```bash
composer global require pkboom/phpunit-watcher
```
...
```bash
composer require pkboom/phpunit-watcher --dev
```
...
When running `phpunit-watcher` from a Composer script, you may need to [redirect input](https://github.com/pkboom/phpunit-watcher/issues/54) in order for the interactive commands to work and [disabled the default timeout](https://getcomposer.org/doc/06-config.md#process-timeout):
...
If you discover any security related issues, please email freek@pkboom.be instead of using the issue tracker.
...
Our address is: Pkboom, Kruikstraat 22, 2018 Antwerp, Belgium.

We publish all received postcards [on our company website](https://pkboom.be/en/opensource/postcards).
